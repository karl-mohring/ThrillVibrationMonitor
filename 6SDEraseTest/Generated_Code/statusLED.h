...
** ===================================================================
*/
#define statusLED_ClrVal() ( \
    (void)clrReg8Bits(PTGD, 0x01U)     /* PTGD0=0x00U */, \
    (Shadow_PTG &= 0xFEU)              /* Set appropriate bit in shadow variable */ \
  )
...
** ===================================================================
*/
#define statusLED_SetVal() ( \
    (void)setReg8Bits(PTGD, 0x01U)     /* PTGD0=0x01U */, \
    (Shadow_PTG |= 0x01U)              /* Set appropriate bit in shadow variable */ \
  )
