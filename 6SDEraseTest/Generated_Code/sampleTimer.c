...
**         Flip-flop registers
**     Contents    :
**         Enable  - byte sampleTimer_Enable(void);
**         Disable - byte sampleTimer_Disable(void);
**
...
/*
** ===================================================================
**     Method      :  sampleTimer_Enable (component TimerInt)
**     Description :
...
/*
** ===================================================================
**     Method      :  sampleTimer_Disable (component TimerInt)
**     Description :
...
void sampleTimer_Init(void)
{
  ...
  sampleTimer_SetCV(0xC2U);            /* Initialize appropriate value to the compare/modulo/reload register */
...
** ===================================================================
*/
ISR(sampleTimer_Interrupt)
{
  /* RTCSC: RTIF=1 */
  setReg8Bits(RTCSC, 0x80U);           /* Reset real-time counter request flag */ 
  sampleTimer_OnInterrupt();           /* Invoke user event */
}
