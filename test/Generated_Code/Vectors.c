...
/*lint -restore Enable MISRA rule (1.1) checking. */
         ...
         PE_Cnvrt_Interrupt,           /* Int.no. 26 Vadc (at FFCA)                  Used */
         ...
         samplingTimer_Interrupt,      /* Int.no. 16 Vtpm2ch0 (at FFDE)              Used */
         ...
         wirelessSerial_Interrupt,     /* Int.no.  5 Vspi1 (at FFF4)                 Used */
