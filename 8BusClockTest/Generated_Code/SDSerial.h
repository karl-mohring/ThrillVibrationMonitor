...
#define SDSerial_BM_2_666667US    0    /* Constant for switch to mode 0 */
#define SDSerial_BM_0_083333US    1    /* Constant for switch to mode 1 */


#define SDSerial_EOF 0x00U             /* Value of the empty character defined in the Empty character property. */

#ifndef __BWUserType_SDSerial_TComData
#define __BWUserType_SDSerial_TComData
  typedef byte SDSerial_TComData;      /* User type for communication. */
#endif

#ifndef __BWUserType_SDSerial_TError
#define __BWUserType_SDSerial_TError
  ...
  } SDSerial_TError;                   /* Error flags. For languages which don't support bit access is byte access only to error flags possible.  */
...
__interrupt void SDSerial_Interrupt(void);
/*
** ===================================================================
